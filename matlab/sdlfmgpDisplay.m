function sdlfmgpDisplay(model, spaceNum)

% SDLFMGPDISPLAY Display a switching dynamical Gaussian process model.
% FORMAT
% DESC displays in human readable form the contents of the SDLFMGP
% model.
% ARG model : the model structure to be displaced.
% ARG spaceNum : number of spaces to place before displaying model
% structure.
%
% SEEALSO : sdlfmgpCreate, modelDisplay.
%
...
fprintf(spacing);
fprintf('Switching dynamical Latent Force Gaussian process Model:\n')
fprintf(spacing);
...
switch model.approx
 ...
 case 'dtcvar'
  fprintf(spacing);
  fprintf('Variational Deterministic training conditional approximation.\n')
  fprintf('  Number of inducing variables: %d\n', model.k)      
end
